...
Partially repeats the functionality of most commands.
The options and priority of parsing are as follows:

• *Coordinates*: similar to the /coordinates (or /coords) command. Except that it only has 2 separator options: \`:\` or \`,\`.

• *Search*: Similar to the /search command.
`,
}
