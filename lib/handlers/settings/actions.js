...
const { buildKeyboard, getTapMessage } = require('./helpers/message')
const { tapAction, backAction, resultAction } = require('./helpers/actions')
const { clearWaitReply, editField } = require('./helpers/helpers')
...
exports.editReply = async ctx => {
  ...
  const { fieldName, type, settingsMessageId } = wr
