...
exports.waitReplyCategory = (categories, ...fns) => {
  if (!Array.isArray(categories)) return exports.waitReplyCategory([categories])
  return exports.optional(ctx => ctx.waitForceReply && categories.includes(ctx.waitForceReply.category), ...fns)
}
